...
EXCLUDE_METHODS_FROM_MOCKS: Final = [
    "default_platform",
    "event",
    "fire_entity_refreshed_callback",
    "fire_entity_removed_callback",
    ...
    "register_entity_refreshed_callback",
    "register_entity_removed_callback",
    "register_entity_updated_callback",
    "set_usage",
    "unregister_internal_entity_updated_callback",
    "unregister_entity_refreshed_callback",
    "unregister_entity_removed_callback",
