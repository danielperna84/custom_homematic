...
async def async_setup_entry(
    ...
    async_add_switch(control_unit.get_new_hm_entities(platform=HmPlatform.SWITCH))

    async_add_hub_switch(control_unit.get_new_hm_hub_entities(platform=HmPlatform.HUB_SWITCH))
