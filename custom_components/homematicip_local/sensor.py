...
async def async_setup_entry(
    ...
    async_add_sensor(control_unit.get_new_hm_entities(platform=HmPlatform.SENSOR))

    async_add_hub_sensor(control_unit.get_new_hm_hub_entities(platform=HmPlatform.HUB_SENSOR))
